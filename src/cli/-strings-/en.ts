        ...
        RESOURCES: {
            PROGRAM: {
                ...
                OPTIONS: {
                    ...
                    OPTION: "TODO ? ALLRSP only value?? Specifies functions to be performed along with the command (ALLRSP)",
            ...
            TRANSACTION: {
                ...
                OPTIONS: {
                    ...
                    DCLWA: "pecifies the log write-ahead option (N or Y)",
                    ...
                    PGM: "Specifies the parallel processing limit count",
