...
import { ProgramDefinition } from "../../../../src/cli/update/program/Program.definition";
import ProgramHandler from "../../../../src/cli/update/program/Program.handler";
...
describe("UpdateProgramHandler", () => {
    ...
    const functionSpy = jest.spyOn(Update, "updateProgram");
    ...
    it("should call the update program api", async () => {
