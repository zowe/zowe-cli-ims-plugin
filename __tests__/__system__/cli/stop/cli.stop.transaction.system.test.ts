...
describe("Stop transaction command", () => {

    // Create the unique test environment
    beforeAll(async () => {
        testEnvironment = await TestEnvironment.setUp({
            testName: "stop_transaction_command",
    ...
    it("Should stop a transaction by specifying a name", async () => {
        const output = runCliScript(__dirname + "/__scripts__/stop_transaction.sh", testEnvironment,
            [transactionName]);
